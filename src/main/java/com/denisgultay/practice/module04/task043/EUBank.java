...
public class EUBank extends Bank {
    ...
    public static final int LIMIT_OF_WITHDRAWAL_EUR = 2200;
    public static final int LIMIT_OF_FUNDING_USD = 10000;
    public static final int LIMIT_OF_FUNDING_EUR = 20000;
    public static final int VALUE_OF_RATE_USD = 0;
    public static final int VALUE_OF_RATE_EUR = 1;
    ...
    public static final int VALUE_OF_COMMISION_EUR_LESS_1000 = 2;
    public static final int VALUE_OF_COMMISION_EUR_MORE_1000 = 4;
