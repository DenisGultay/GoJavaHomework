...
public class USBank extends Bank {
    ...
    final int LIMIT_OF_WITHDRAWAL_USD = 1000;
    final int LIMIT_OF_WITHDRAWAL_EUR = 1200;
    final int LIMIT_OF_FUNDING_USD = 10000;
    final int LIMIT_OF_FUNDING_EUR = 0;
    final int VALUE_OF_RATE_USD = 1;
    final int VALUE_OF_RATE_EUR = 2;
    ...
    final int VALUE_OF_COMMISION_EUR_LESS_1000 = 6;
    final int VALUE_OF_COMMISION_EUR_MORE_1000 = 8;
